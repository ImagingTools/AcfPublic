#ifndef iipr_CSingleArcProjectionSupplierComp_included
#define iipr_CSingleArcProjectionSupplierComp_included
...
*/
class CSingleArcProjectionSupplierComp:
...
public:
	...
	I_BEGIN_COMPONENT(CSingleArcProjectionSupplierComp);
		...
		I_ASSIGN(m_arcCompPtr, "ArcProvider", "Provides arc", true, "ArcProvider");
...
#endif // !iipr_CSingleArcProjectionSupplierComp_included
