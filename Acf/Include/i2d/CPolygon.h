...
public:
	...
	*/
	...
	/**
		Converts from another object if possible.
		\param segmentsCount optional parameter defining object approximation segments count (if applicable).
	*/
	virtual bool ConvertFrom(const i2d::IObject2d& object, int segmentsCount = 0);
