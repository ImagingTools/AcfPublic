...
function (acf_custom_build PROJECT_BINARY_DIR ARXC_FILES ARXC_CONFIG ACF_CONVERT_REGISTRY ACF_CONVERT_CONFIG ACF_CONVERT_FILES ACF_ENV_VARS)
	...
	message("##############################################################################")
	message(STATUS "${ACF_ENV_VARS_SINGLE_STRING}")
	message("${ACF_ENV_VARS_SINGLE_STRING}")
...
#	set(ARXC_OUTFILE "${PROJECT_BINARY_DIR}/${ARXC_OUTFILE_NAME}")
	...
	message("ARXC_OUTFILE ${ARXC_OUTFILE}")
	
	message("ARGS ${ARXCBIN} ${ARXC_FILES} -o ${ARXC_OUTFILE} -config ${ARXC_CONFIG} -conf_name ${TARGETNAME} -env_vars ${ACF_ENV_VARS_SINGLE_STRING} ")
...
#	add_custom_target(
#			ARXC${PROJECT_NAME} ALL
#			MAIN_DEPENDENCY ${ARXC_FILES}
#			DEPENDS ${ARXC_OUTFILE}
#		)


	message("SOURCES_FILE_AUX " ${SOURCES_FILE_AUX})
	message("HEADER_FILE_AUX " ${HEADER_FILE_AUX})
