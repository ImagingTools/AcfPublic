...
if(NOT DEFINED DEPENDS_OF_ACF OR ${PROJECT_NAME} STREQUAL "Arxc")
#	message("NOT DEFINED DEPENDS_OF_AC")
	set(DEPENDS_ATTR MAIN_DEPENDENCY ${ARXC_FILES} VERBATIM)
else()
#	message("DEFINED DEPENDS_OF_AC")
    set(DEPENDS_ATTR DEPENDS Arxc VERBATIM)
endif()
...
#set(RC_FILE "${AUX_INCLUDE_DIR}/${PROJECT_NAME}/${PROJECT_NAME}.rc")
    set_property(SOURCE ${RC_FILE}.res PROPERTY GENERATED 1)
	set_property(SOURCE ${RC_FILE} PROPERTY GENERATED 1)
if(WIN32)
