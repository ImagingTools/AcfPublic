...
Module {
    ...
    property string libFilePathRelease: "C:/Qt/Qt5.4.1/5.4/msvc2013_64/lib/Qt5Core.lib"
    ...
    property string generatedFilesDir: product.buildDirectory + "/GeneratedFiles/" + product.name
    ...
    cpp.includePaths: {
        var paths = ["C:/Qt/Qt5.4.1/5.4/msvc2013_64/include", "C:/Qt/Qt5.4.1/5.4/msvc2013_64/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib", "C:/Qt/Qt5.4.1/5.4/msvc2013_64/lib/qtmaind.lib"] : ["Shell32.lib", "C:/Qt/Qt5.4.1/5.4/msvc2013_64/lib/qtmain.lib"]);
        }
